...
- **CBE**: Look for "Commercial Bank of Ethiopia" or "CBE" logos/text, SMS messages from "CBE" ("Dear [Payer] You have successfully transferred ETB [Amount] from account [SenderAccount] to account [ReceiverAccount] ([ReceiverName]). Service charge of ETB... total of ETB [Total]... https://mbreciept.cbe.com.et/v2-[Token]"), or CBE App transaction summary screens ("Transaction Completed Successfully! You have successfully transferred [Amount] ETB from your account [SenderAcc] [SenderName] for [ReceiverName] with [Bank] account number [ReceiverAcc]. on [Date Time] with Transaction ID: [FT...]. Remark: ... Total Amount Debited: [Total] ETB..."). The transaction reference starts with "FT" or is in the receipt link path (v2-...).
